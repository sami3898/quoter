        ...
        this.state = {
            data: [
                ...
                },
                {
                    ...
                    ans: 'QUOTER generate random quote from REST API everytime. so maybe there is a chance you see same quote frequantly.'
                },
                // {
                //     id:3,
        ...
        return (
            <View>
                <View style={styles.questionStyle}>
                    <Text allowFontScaling={false} style={styles.questionText}>{item.que}</Text>
                </View>
                <View style={styles.answerStyle}>
                    <Text allowFontScaling={false} style={styles.answerText}>{item.ans}</Text>
                </View>
            ...
            <View style={styles.container}>
                ...
                <View style={styles.infoContainer}>
                    ...
                    <View style={styles.logoContainer}>
                        <TouchableOpacity onPress={() => Linking.openURL('https://www.instagram.com/sami_3898/')}>
                            <Image 
                                source={INSTA_ICON}
                                style={styles.logoStyle}
                            />
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => Linking.openURL('mailto:sami.sk868@gmail.com')}>
                            <Image 
                                source={GMAIL_ICON}
                                style={styles.logoStyle}
                            />
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => Linking.openURL('https://twitter.com/sami3898')}>
                            <Image 
                                source={TWITTER_ICON}
                                style={styles.logoStyle}
                            />
                ...
                {/* <View style={{width: '100%', height: 'auto', bottom: 0,position: 'absolute'}}>
                    <BannerAd unitId={bannerId} onAdLoaded={() => {
